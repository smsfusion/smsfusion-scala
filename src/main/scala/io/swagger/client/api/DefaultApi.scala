...
class DefaultApi(val defBasePath: String = "http://api.smsfusion.com.au/",
  ...
  def getHLR(key: String, num: String, cc: Option[String] = None): Option[HLRCallback] = {
    ...
    if (key == null) throw new Exception("Missing required parameter 'key' when calling DefaultApi->getHLR")

    if (num == null) throw new Exception("Missing required parameter 'num' when calling DefaultApi->getHLR")
  ...
  def getHLRCallback(key: String, num: List[String], cb: String, cc: Option[String] = None): Option[HLRResult] = {
    ...
    if (key == null) throw new Exception("Missing required parameter 'key' when calling DefaultApi->getHLRCallback")

    if (num == null) throw new Exception("Missing required parameter 'num' when calling DefaultApi->getHLRCallback")

    if (cb == null) throw new Exception("Missing required parameter 'cb' when calling DefaultApi->getHLRCallback")
